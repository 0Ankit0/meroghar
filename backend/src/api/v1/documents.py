...
async def get_document_download_url(
    ...
    if document.uploaded_by == current_user.id:
        ...
        if property_obj and (property_obj.owner_id == current_user.id or property_obj.managed_by == current_user.id):
            has_access = True
...
async def list_documents(
    ...
    expiring_before: Optional[datetime] = Query(None, description="Filter documents expiring before date"),
    expiring_after: Optional[datetime] = Query(None, description="Filter documents expiring after date"),
...
async def create_document_version(
    ...
    new_document = await doc_service.create_document_version(
        ...
        new_document_data=new_version_data,
        session=session
    )
