...
async def upload_receipt(
    ...
    try:
        ...
        logger.info(
            f"Receipt uploaded for expense {expense_id}: {receipt_url}"
        )
...
async def approve_expense(
    ...
    try:
        ...
        logger.info(
            f"Expense {expense_id} {request.status} by owner {current_user.id}"
        )
...
async def reimburse_expense(
    ...
    try:
        ...
        logger.info(
            f"Expense {expense_id} marked as reimbursed by owner {current_user.id}"
        )
