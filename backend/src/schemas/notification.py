...
class NotificationCreateRequest(BaseModel):
    ...
    deep_link: str | None = Field(None, max_length=500, description="Deep link for navigation")
    metadata: dict[str, Any] | None = Field(None, description="Additional metadata as JSON")
