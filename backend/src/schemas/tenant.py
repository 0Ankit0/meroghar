...
class TenantCreateRequest(BaseModel):
    ...
    electricity_rate: Decimal | None = Field(
        None,
        ge=0,
        max_digits=8,
        decimal_places=4,
...
class TenantUpdateRequest(BaseModel):
    ...
    move_out_date: date | None = Field(None, description="Tenant move-out date")
...
class TenantResponse(BaseModel):
    ...
    security_deposit: Decimal | None = Field(None, description="Security deposit amount")
    electricity_rate: Decimal | None = Field(None, description="Per-unit electricity rate")
...
class TenantBalanceResponse(BaseModel):
    ...
    last_payment_date: date | None = Field(None, description="Last payment date")
