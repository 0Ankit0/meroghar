...
class Settings(BaseSettings):
    ...
    khalti_secret_key: str | None = Field(default=None, alias="KHALTI_SECRET_KEY")
    khalti_use_sandbox: bool = Field(default=True, alias="KHALTI_USE_SANDBOX")
    khalti_return_url: str | None = Field(default=None, alias="KHALTI_RETURN_URL")
    khalti_website_url: str | None = Field(default=None, alias="KHALTI_WEBSITE_URL")

    # eSewa Payment Gateway (Nepal)
    esewa_merchant_id: str | None = Field(default=None, alias="ESEWA_MERCHANT_ID")
    esewa_secret_key: str | None = Field(default=None, alias="ESEWA_SECRET_KEY")
    esewa_use_sandbox: bool = Field(default=True, alias="ESEWA_USE_SANDBOX")

    # IME Pay Payment Gateway (Nepal)
    imepay_merchant_code: str | None = Field(default=None, alias="IMEPAY_MERCHANT_CODE")
    imepay_secret_key: str | None = Field(default=None, alias="IMEPAY_SECRET_KEY")
    ...
    s3_bucket_receipts: str | None = Field(default=None, alias="S3_BUCKET_RECEIPTS")
    s3_bucket_uploads: str | None = Field(default=None, alias="S3_BUCKET_UPLOADS")
    ...
    @property
    def TWILIO_PHONE_NUMBER(self) -> str | None:
        """Get Twilio Phone Number."""
        return self.twilio_phone_number

    @property
    def TWILIO_WHATSAPP_NUMBER(self) -> str | None:
