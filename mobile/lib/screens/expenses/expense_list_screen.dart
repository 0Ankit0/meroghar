...
class _ExpenseListScreenState extends State<ExpenseListScreen> {
  ...
  void _showFilterDialog() {
    showDialog(
      ...
      builder: (context) {
        ...
        ExpenseStatus? tempStatus = _filterStatus;
  ...
  void _navigateToExpenseForm() async {
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color:
                            expense.isReimbursed ? Colors.green : Colors.orange,
                      ),
                      const SizedBox(width: 4),
                      Text(
                ...
                children: [
                  ...
                  if (expense.receiptUrl != null) ...[
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () {
                        // Open receipt in browser or image viewer
                      },
                    ),
                  ],
                ],
